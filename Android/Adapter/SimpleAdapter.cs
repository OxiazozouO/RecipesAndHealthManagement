...
{
    private readonly App.Activity _activity;
    public List<T> Models { get; set; } = [];

    protected SimpleAdapter(App.Activity activity)
    {
        _activity = activity;
        Init();
    }
    ...
    public abstract bool CreateItem(App.Activity activity, int pos, out Java.Lang.Object holder, out View root);
